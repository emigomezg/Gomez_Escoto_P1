...
void GPIO_sw2_begin(void){
    gpio_pin_control_register_t sw_pcr_config = (GPIO_MUX1|GPIO_PE|GPIO_PS);
    GPIO_clock_gating(GPIO_C);
    GPIO_pin_control_register(GPIO_C,bit_6,&sw_pcr_config);
    GPIO_data_direction_pin(GPIO_C,GPIO_INPUT,bit_6);
}
void GPIO_sw3_begin(void){
    gpio_pin_control_register_t sw_pcr_config = (GPIO_MUX1|GPIO_PE|GPIO_PS);
    GPIO_clock_gating(GPIO_A);
    GPIO_pin_control_register(GPIO_A,bit_4,&sw_pcr_config);
