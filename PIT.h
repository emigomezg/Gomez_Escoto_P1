...
typedef enum {
	PIT_0, PIT_1, PIT_2, PIT_3
} PIT_timer_t;

typedef struct {
	uint8_t pit_flag_0 :1;
	uint8_t pit_flag_1 :1;
	uint8_t pit_flag_2 :1;
	uint8_t pit_flag_3 :1;
 ...
 */
uint8_t PIT_get_interrupt_flag_status(PIT_timer_t);
...
/********************************************************************************************/
/*!
 \brief	It enable the timer capabilities of the PIT
