...
/** Constant that represent the clock for all Ports*/
#define GPIO_CLOCK_GATING_PORTS 0x00003E00


/** Selects a pull resistor */
...
uint8_t GPIO_pin_control_register(gpio_port_name_t port_name, uint8_t pin,
		gpio_pin_control_register_t* pinControlRegister);
/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
...
/********************************************************************************************/
/*!
 \brief This initialize the required setting for the switcvh sw2.
 \param[in] port_name Selected Port.
 \param[in] pin Pin to be toggled.
 \return void
 */
void GPIO_sw2_begin(uint8_t);
/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
 \brief This verifies that the switch is not pressed.
 \param[in] port_name Selected Port.
 \param[in] pin Pin to be toggled.
 \return void
 */
void GPIO_sw3_begin(uint8_t);
/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
 \brief this get the value of the switch
 \param[in] port_name Selected Port.
 \param[in] pin Pin to be toggled.
 \return void
 */
...
/********************************************************************************************/
/*!
 \brief this stays in loop until switch is release
 \param[in] port_name Selected Port.
 \param[in] pin Pin to be toggled.
 \return void
 */
